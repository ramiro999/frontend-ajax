...
const createCustomer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await createAccount(newCustomerData);
  ...
  return (
    <form class="font-[sans-serif] m-6 max-w-4xl mx-auto">
      <h3 class="text-4xl font-extrabold pb-10 mx-auto  text-center">
        Crear proveedor
      </h3>
      ...
      <button
        type="button"
        class="mt-8 px-6 py-2.5 w-full text-sm font-semibold bg-indigo-700 text-white rounded hover:bg-indigo-800"
      >
        Crear proveedor
      </button>
    </form>
